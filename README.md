...
if lam < mu:
    ...
    print("Average time spent by an object in the conveyor: %0.2f" % Wq)
    print("Probability that the system is busy: %0.2f" % (lam/mu))
    print("Probability that the system is empty: %0.2f" % (1 - (lam/mu)))

else:
    print("\nWarning! Objects overflow will happen in the conveyor")

print("-----------------------------------------")
```
## Output :
<img width="1187" height="373" alt="image" src="https://github.com/user-attachments/assets/180ca042-9557-46e9-8b99-8ceb1ae90e74" />
